...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> post(@RequestBody Usuario usuario){  			//@RequestBody -> Informa que o objeto Turma virá via Body (Corpo da requisição)
	...
	public ResponseEntity<Usuario> Put(@RequestBody Usuario usuario){				//@RequestBody -> Informa que o objeto Turma virá via Body (Corpo da requisição)
