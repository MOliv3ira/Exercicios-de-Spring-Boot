...
public class PostagemController {
	...
	public ResponseEntity<Postagem> post(@RequestBody Postagem postagem){  			//@RequestBody -> Informa que o objeto Turma virá via Body (Corpo da requisição)
	...
	public ResponseEntity<Postagem> Put(@RequestBody Postagem postagem){				//@RequestBody -> Informa que o objeto Turma virá via Body (Corpo da requisição)
